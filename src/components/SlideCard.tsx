...
const badgePalette: Record<string, string> = {
  bullets: "bg-white/10 text-white border border-white/20",
  dualColumn: "bg-white/10 text-white border border-white/20",
  timeline: "bg-white/10 text-white border border-white/20",
  statBlock: "bg-white text-slate-900 border border-transparent",
  imageCallout: "bg-white/10 text-white border border-white/20",
  comparison: "bg-white/10 text-white border border-white/20",
  checklist: "bg-white/10 text-white border border-white/20",
  quote: "bg-white text-slate-900 border border-transparent",
};
      ...
      <div className="relative flex flex-col gap-8">
        ...
        <div className="grid gap-6">
          {slide.sections.map((section) => (
            <SectionRenderer key={section.type + slide.id} section={section} />
          ))}
        </div>
      </div>
    </article>
